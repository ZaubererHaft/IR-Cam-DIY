...
#define SDA_IN   {SDA_GPIO_Port->MODER&=~(3<<(7*2));SDA_GPIO_Port->MODER|=0<<7*2;}
#define SDA_OUT  {SDA_GPIO_Port->MODER&=~(3<<(7*2));SDA_GPIO_Port->MODER|=1<<7*2;}

#define sda      HAL_GPIO_ReadPin(SDA_GPIO_Port,SDA_Pin)
